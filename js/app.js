...
function Artist(artistName, album, label, year, albumImage, bio) {
...
function getArtist() {
  ...
  for (let i = 0; i < sections.length; i++) {
    ...
    artistList += "<tr><td>Album:</td><td>" + allArtists[i].album + "</td></tr>";
    ...
    artistList +=
      ...
      allArtists[i].albumImage +
      '.jpeg "alt="' +
      allArtists[i].album +
      '">';
    artistList +=
      "<h1>Artist Bio: </h1><hr><p>" + allArtists[i].bio + "</p>";
